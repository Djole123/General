    ...
    <nav class="top-bar" data-topbar>
      ...
      <section class="top-bar-section">
        ...
        <ul class="right">
          ...
          <li class=""><a href="/dashboard/faq.php">FAQs</a></li>
          <li class=""><a href="/dashboard/howto.php">HOW-TO Guides</a></li>
    ...
    <div class="hero">
       <div class="row">
         <div class="large-12 columns">
            ...
            <p>Check out our <a href="https://www.apachefriends.org/bitnami_for_xampp.php" target="_blank" >Bitnami for XAMPP Start Guide</a> for more information about the applications installed.</p>
         </div>
       </div>
    </div>
        ...
        <div class="row">
          <div class="large-8 columns">
            ...
            <ul class="inline-list">
              <li><a href="https://www.apachefriends.org/blog.php">Blog</a></li>
              <li><a href="https://www.apachefriends.org/privacy_policy.php">Privacy Policy</a></li>
              <li>
